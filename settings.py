...
def init():
    ...
    # Grid settings
    global ROWS, COLS, WIDTH, HEIGHT, GRID_HEIGHT, GRID_COL, PROBABILITY
    ROWS = 50
    COLS = 100
    WIDTH = 1401
    HEIGHT = 801
    ...
    global RUN_SEL_COLOR, RUN_DE_COLOR, RESET_SEL_COLOR, RESET_DE_COLOR, ALG_CHOICE, ALG_SEL_COLOR, ALG_DE_COLOR, RAND_SEL_COLOR, RAND_DE_COLOR
    ...
    # Text settings
    global RUN_FONT, RESET_FONT, RAND_FONT, FONT_SEL_COLOR, FONT_DE_COLOR, RUN_FONT_COLOR, RESET_FONT_COLOR, BFS_FONT_COLOR, ASTAR_FONT_COLOR, RAND_FONT_COLOR
    pygame.font.init()
